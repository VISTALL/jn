 ...
 * easy, and it is because its size is fixed.  {@link com.jds.jn_module.utils.buffer.NioBuffer} introduces
 ...
 * </pre>
 * The underlying {@link java.nio.ByteBuffer} is reallocated by {@link com.jds.jn_module.utils.buffer.NioBuffer} behind
 ...
 * of the allocated memory area is not being used.  {@link com.jds.jn_module.utils.buffer.NioBuffer} provides
 * <tt>autoShrink</tt> property to take care of this issue.  If
 * <tt>autoShrink</tt> is turned on, {@link com.jds.jn_module.utils.buffer.NioBuffer} halves the capacity
 ...
 * <p>
 * {@link com.jds.jn_module.utils.buffer.NioBufferAllocator} interface lets you override the default buffer
 ...
 * {@link #setAllocator(com.jds.jn_module.utils.buffer.NioBufferAllocator)}.
 * </p>
 *
