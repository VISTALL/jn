...
/**
 * A base implementation of {@link jds.mina.core.buffer.IoBuffer}.  This implementation
 * assumes that {@link jds.mina.core.buffer.IoBuffer#buf()} always returns a correct NIO
 ...
 * @see jds.mina.core.buffer.IoBufferAllocator
 */
public abstract class AbstractNioBuffer extends NioBuffer
{
	 ...
	 */
	protected AbstractNioBuffer(NioBufferAllocator allocator, int initialCapacity)
	{
	 ...
	 * <tt>autoExpand</tt> property is <tt>true</tt>.
	 */
	private NioBuffer autoExpand(int pos, int expectedRemaining)
	{
		if (isAutoExpand())
		{
