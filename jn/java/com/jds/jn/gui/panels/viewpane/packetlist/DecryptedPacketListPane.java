...
import com.jds.jn.gui.panels.viewpane.packetlist.sub.FormForSearch;
 ...
 * Time: 13:54:45
 */
public class DecryptedPacketListPane extends PacketListPanel<DecryptedPacket>
{
	...
	private DecryptedPacketListModel _model = new DecryptedPacketListModel();

	private JScrollPane _packetScrollPane;
	private JTable _packetList;
	private JSlider _transperyPacket;
	private JPanel main;
	private FormForSearch _formForSearch;
	...
	public DecryptedPacketListPane(ViewPane pane)
	{
		...
		registerKeyboardAction(new ActionListener()
		{
			public void actionPerformed(ActionEvent e)
			{
				_formForSearch.setVisible(!_formForSearch.isVisible());
			}
	...
	private void createUIComponents()
	{
		...
		_formForSearch = new FormForSearch(_pane);
		_formForSearch.setVisible(false);

		_packetList = new JTable(_model);
		_packetList.getSelectionModel().setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
		_packetList.setDefaultRenderer(Object.class, new PacketTableRenderer(_model));
	...
	@Override
	public DecryptedPacketListModel getModel()
	{
		return _model;
	}

	public FormForSearch getFormForSearch()
	{
		return _formForSearch;
	}
	...
	private void $$$setupUI$$$()
	{
		...
		main.add(_transperyPacket, new GridConstraints(2, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
		main.add(_formForSearch.$$$getRootComponent$$$(), new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_NORTH, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
	}
